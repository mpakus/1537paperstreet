...
use commands::{
    ...
    reveal_in_finder, save_user_file, session_restore, session_set, text_format, themes_css,
    themes_list, tree_expanded_get, tree_expanded_set, tree_read_dir, updates_check,
    updates_install, updates_relaunch, watch_set_expanded, watch_start, watch_stop,
};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent_prompt_history_clear,
            agent_prompt_history_remove,
            agent_start,
            agent_stop,
            agent_prompt,
            agent_cancel,
